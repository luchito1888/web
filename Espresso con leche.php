...
<div class="container-hero">
    ...
    <div class="product-image">
        <img src="ima/e3.jpeg" alt="Matcha Frappuccino Alto">
    </div>
...
<script>
    const productId = 14; // Cambia esto al ID del producto que quieres mostrar
    ...
    <button class="btn btn-primary" onclick="agregarAlCarrito(14)">Agregar al carrito</button>
</div>
