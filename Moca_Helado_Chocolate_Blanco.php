...
<head>
    ...
    <title>Moca Helado con Chocolate Blanco</title>
...
<div class="container-hero">
    ...
    <div class="product-image">
        <img src="img/m11.jpg" alt="Matcha Frappuccino Alto">
    </div>
...
<script>
    const productId = 4; // Cambia esto al ID del producto que quieres mostrar
