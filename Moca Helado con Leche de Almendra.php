...
<head>
    ...
    <title>Moca Helado con Leche de Almendra</title>
...
<div class="container-hero">
    ...
    <div class="product-image">
        <img src="img/m14.jpg" alt="Matcha Frappuccino Alto">
    </div>
...
<script>
    const productId = 7; // Cambia esto al ID del producto que quieres mostrar
