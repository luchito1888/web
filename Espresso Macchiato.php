...
<div class="content-shopping-cart">
  ...
  <div class="cart-dropdown">
    ...
    <div class="product-image">
        <img src="ima/e4.jpeg" alt="Matcha Frappuccino Alto">
    </div>
...
<script>
    const productId = 15; // Cambia esto al ID del producto que quieres mostrar
    ...
    <div class="actions">
    <button class="btn btn-primary" onclick="agregarAlCarrito(15)">Agregar al carrito</button>
</div>
</div>
