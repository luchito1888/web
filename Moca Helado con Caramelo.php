...
<head>
    ...
    <title>Moca Helado con caramelo</title>
...
<div class="container-hero">
    ...
    <div class="product-image">
        <img src="img/m10.jpg" alt="Matcha Frappuccino Alto">
    </div>
...
<script>
    const productId = 2; // Cambia esto al ID del producto que quieres mostrar
