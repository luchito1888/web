...
<div class="container-hero">
  ...
  <div class="cart-dropdown">
    ...
    <div class="cart-summary">
      <p>Total: <strong id="cart-total">S/ 0.00</strong></p>
    </div>
...
<script>
    const productId = 13; // Cambia esto al ID del producto que quieres mostrar
    ...
    <div class="actions">
    <button class="btn btn-primary" onclick="agregarAlCarrito(13)">Agregar al carrito</button>
</div>
</div>
