...
<script>
    const productId = 12; // Cambia esto al ID del producto que quieres mostrar
    ...
    <button class="btn btn-primary" onclick="agregarAlCarrito(12)">Agregar al carrito</button>
</div>
