...
<head>
    ...
    <title>Moca Helado con Malvaviscos</title>
...
<div class="container-hero">
    ...
    <div class="product-image">
        <img src="img/m12.jpg" alt="Matcha Frappuccino Alto">
    </div>
...
<script>
    const productId = 5; // Cambia esto al ID del producto que quieres mostrar
